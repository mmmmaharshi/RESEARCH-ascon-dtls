...
5. **4. Security analysis**
   ...
   - 4.3 Symbolic model (Tamarin: 8 lemmas incl. sequence-number privacy) — src: `tools/tamarin/dtls13-ascon-record.spthy`, `tools/tamarin/README.md`, `design-01-record-layer.md` §129.
